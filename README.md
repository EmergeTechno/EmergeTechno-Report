...
| US ID | US TITLE | TASK ID | TASK DESCRIPTION | TASK ESTIMATION | ASSIGNED TO | STATUS |
|--------|------------|-------------|--------------------------|------------------------|-------------------|-----------|
| US019 | US TITLE | TASK ID | TASK DESCRIPTION | TASK ESTIMATION | ASSIGNED TO | STATUS |
| US020 | US TITLE | TASK ID | TASK DESCRIPTION | TASK ESTIMATION | ASSIGNED TO | STATUS |
| TS006 | US TITLE | TASK ID | TASK DESCRIPTION | TASK ESTIMATION | ASSIGNED TO | STATUS |
| TS008 | US TITLE | TASK ID | TASK DESCRIPTION | TASK ESTIMATION | ASSIGNED TO | STATUS |
| TS005 | US TITLE | TASK ID | TASK DESCRIPTION | TASK ESTIMATION | ASSIGNED TO | STATUS |
| TS007 | US TITLE | TASK ID | TASK DESCRIPTION | TASK ESTIMATION | ASSIGNED TO | STATUS |
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE1NjUyNzMxNiw2MjcwNjA3OTEsNjc2OT

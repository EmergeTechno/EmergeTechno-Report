...
| 4.1| 23/11/2023|Rafael semanez Enrique Postigo| Se agregaron las secciones restantes y avances del sprint|
...
|  ----------  |  ----------  |  ----------  | 
| Comunica oralmente con efectividad a diferentes rangos de audiencia| **Enrique Postigo (TB1):** Después de avanzar en la entrega de la TB1, se estableció una comunicación efectiva a través de reuniones grupales y presentaciones, lo que facilitó la compartición e intercambio de ideas entre los diferentes compañeros. **Bruno Palomino (TB1):** Después de llevar a cabo la exposición para esta entrega TB1, logramos una comunicación efectiva para transmitir las ideas sobre el proyecto tanto al profesor como a nuestros compañeros. **Diego Talledo (TB1):** En nuestra primera entrega, realizamos las distribuciones y planificaciones de las sesiones en las trabajamos enearn equipo principalmente en el eventStorming. **Rafael Samanez(TB1):** Se dDefinió comos esta propuesta va a implementarse y como se cobraría para gel alcando ideas innovadoras para el mercado de la agricultura.**Enrique Postigo(TP1):** Tras el desarrollo de una exposición sincrónica para esta entrega TP1 se aplicó una comunicación eficiente para brindar las nuevas ideas acerca de los diagramas de arquitectura de cada uno de los bounded context hacia el profesor y compañeros.**Bruno Palomino (TP1):** ras nce grupal para la entrega TP1 se aplicó los conocimientos aprendidos de los diagramas de arquitectura basados en componentes que se utilizaran en cada bounded context del proyecto.**Diego Talledo(TP1)**: En estre entregable me encargue de la correcciondel informe, desarrollo de artefactos como lo fueron los mockups y coordinacion de las reuniones y desarrollo de la aplicacion web.**Rafael Samanez(TP1)**: En estre entregable me encargue de la correcciondel informe, desarrollo de artefactos como lo fueron los mockups y coordinacion de las reuniones y desarrollo de la aplicacion web.**Enrique Postigo(TB2):** Tras el desarrollo de una exposición sincrónica para esta entrega TB2 se aplicó una comunicación eficiente para brindar las nuevas ideas acerca de la elaboracion del sprint y las dificultades en este.**Bruno Palomino (TB2):** En esta entrega grupal para la entrega TB2 se aplicó los conocimientos aprendidos del desarrollo de software tanto backend como frontend para su correcta elaboracion.**Diego Talledo(TB2)**: En estre entregable me encargue del despliegue y elaboración de sprint tanto backend como frontend.**Rafael Samanez(TB2)**: En estre entregable me encargue de la correcciondel informe y entrevistas para la validacion.**Enrique Postigo(TF):** Informé puntualmente a mi equipo sobre todos los progresos realizados..**Bruno Palomino (TF):** Realicé mis tareas dentro del período acordado por el equipo.**Diego Talledo(TF)**: Colaboré con mis colegas en la ejecución del sprint, comunicándome efectivamente y ofreciendo asistencia cuando fue necesario.**Rafael Samanez(TF)**: Contribuí activamente en la creación y participé en la presentación de los diversos productos desarrollados. |**TB1:** En esta entrega de la TB1, se elaboraron los capítulos 1, 2, 3 y 4, que incluyeron el análisis de los requisitos de nuestro público objetivo. A través de este proceso, se fueron planteando las historias de usuario relacionadas con estos requisitos y se organizaron en un backlog, ordenándolas de menor a mayor importancia y un avance de como seria la arquitectura del proyecto. Al final, logramos comunicar de manera oral eficaz tanto al profesor como a nuestros compañeros. **TP1:** Para esta entrega del TP1, se abordaron los capítulos 5 y 6 del proyecto, donde se proporcionó una explicación detallada de cada uno de los "bounded contexts" identificados en los capítulos anteriores. Además, se llevó a cabo el diseño de la solución de experiencia de usuario (UX) destinada a nuestro público objetivo.Durante la exposición sincrónica, se destacó cada punto de estos nuevos avances mediante una comunicación oral efectiva dirigida al profesor y a los compañeros.**TB2:** Para esta entrega del TB2, nos enfocamos en la elaboración de los sprints de desarrollo tanto para el backend como el frontend del proyecto. Durante este proceso, llevamos a cabo entrevistas con los stakeholders y usuarios para definir los requisitos y prioridades del proyecto. Además, abordamos el Capítulo 7, donde se proporcionó una explicación detallada de los nuevos elementos y desafíos identificados en esta etapa. **TF:** Destacamos la relevancia de adquirir habilidades para llevar a cabo proyectos de manera colaborativa, facilitando así la división de responsabilidades.|
|Comunica por escrito con efectividad a diferentes rangos de audiencia | **Enrique Postigo(TB1):** En esta entrega de la TB1, se empleó una comunicación escrita eficaz con el profesor a través del desarrollo del informe o documento.**Bruno Palomino(TB1):** Se han creado los artefactos asignados para esta entrega de acuerdo a lo acordado en las reuniones y siguiendo una comunicación escrita efectiva.**Diego Talledo (TB1):** Al realizar las entrevistas logramos identificar a nuestros usuarios, analizar sus requerimientos y sus expectativas. **Rafael Samanez(TP1):** De acuerdo a las reuniones hemos analizado las necesidades dmediante loas agricultoreentrevistas ,e hemos determinado lo necesario para implementar nuestra solución de software e ls s  historias de usuarios   para resolver el problema de la agricultura en Lima . **Enrique Postigo(TP1):** Se aplicó una buena comunicación de forma escrita hacia el profesor durante el desarrollo del informe según el formato establecido en la plantilla de la TP1. De igual forma, se colocó imágenes de lo nuevo presentado para que puedan ervir como apoyo visual en la comprensión lectora. **Bruno Palomino(TP1):** Para esta entrega se aplicó una comunicación grupal íntegra de forma escrita al profesor mediante los nuevos diagramas de arquitectura desarrollados en el proyecto. **Diego Talledo (TP1):** Atraves de la maquetacion de la aplicacion logre entender como nuestros usuarios sentiran la interaccion con nuestra aplicacion. **Rafael Samanez(TP1):** De acuerdo a las reuniones hemos analizado los datos precisos para la elaboracion de los diagramas .**Enrique Postigo(TB2):** Se aplicó una buena comunicación de forma escrita hacia el profesor durante el desarrollo del informe según el formato establecido en la plantilla de la TP1. De igual forma, se colocó imágenes de lo nuevo presentado para que puedan servir como apoyo visual en la comprensión lectora. **Bruno Palomino(TB2):** Para esta entrega se aplicó una comunicación grupal íntegra de forma escrita al profesor mediante el sprint entregado. **Diego Talledo (TB2):** Atraves de las entrevistas de la aplicacion logre entender como nuestros usuarios sentiran la interaccion con nuestra aplicacion. **Rafael Samanez(TB2):** De acuerdo a las reuniones hemos analizado lo mas necesario para este sprint . **Enrique Postigo(TF):** Al desarrollar dispositivos IoT, adquirí una comprensión más profunda de la importancia de esta tecnología para nuestros usuarios.**Bruno Palomino(TF):** Amplié mi comprensión sobre nuestros usuarios mediante la realización de entrevistas.**Diego Talledo (TF):** Exploré a fondo nuestros segmentos objetivos mediante la realización de entrevistas y la incorporación de sus requisitos en nuestra página web. **Rafael Samanez(TF):** Se logró obtener un mayor conocimiento sobre los usuarios.|**TB1:** Para la entrega de la TB1, se elaboró un informe que incluyó todos los requisitos recopilados de los usuarios, lo que proporciona al equipo una abundante información sobre ellos. Esto nos permite utilizar diversas herramientas para organizar esta información. En consecuencia, el informe desarrollado proporciona una comunicación escrita efectiva para el docente. **TP1:** Para la entrega del TP1, se elaboró un informe que abarcaba todos los elementos nuevos que debían presentarse de acuerdo al cronograma establecido. En esta ocasión, nos enfocamos en los capítulos 5 y 6, donde aplicamos los conocimientos adquiridos para crear detalladamente cada diagrama de componentes y código correspondiente a cada contexto acotado. Además, desarrollamos un diseño de solución de experiencia de usuario (UX) dirigido a nuestro público objetivo. **TB2:** Para la entrega del TB2, se elaboró un informe que abarcaba todos los elementos nuevos que debían presentarse de acuerdo al cronograma establecido. En esta ocasión, nos enfocamos en la elaboración de los sprints de desarrollo tanto para el backend como el frontend, donde aplicamos los conocimientos adquiridos para crear detalladamente cada tarea y código correspondiente a cada contexto acotado. Además, realizamos entrevistas con los stakeholders y usuarios para definir los requisitos y prioridades del proyecto, lo que nos permitió diseñar una solución que se ajusta a las necesidades de nuestro público objetivo. TF: Conocer los requisitos de nuestros usuarios es esencial para poder crear un producto final de alta calidad.
|
...
En línea con su misión, CropMaster tiene como propósito fundamental asistir a las personas en su empeño por llevar a cabo una siembra eficiente, ya sea en gran escala o incluso en entornos domésticos. Esto se logra a través de una plataforma segura que proporciona recomendaciones y guías adaptadas a las necesidades individuales de cada agricultor.

Mirando hacia el futuro, CropMaster persigue una visión audaz: convertirse en una empresa líder que desempeñe un 				papel esencial en la reducción de la prevalencia de alimentos transgénicos. Esta visión se materializa al ofrecer una plataforma fiable y accesible que permite a cualquier persona involucrarse en la creación y el cultivo de su propio alimento. Al mismo tiempo, CropMaster busca contribuir al mejoramiento de los cultivos a gran escala, propiciando la producción de alimentos de mayor calidad y valor nutricional.
...
|Rafael Samanez Narvaez| **Me llamo Rafael, tengo 25 años. Soy estudiante de la carrera de software. Escogí esta carrera por mi gusto con la tecnología e innovación. Me gusta trabajar en equipo y mejorar para terminar proyectos en buena calidad.**|![Rafael Samanez](https://i.ibb.co/k6t88Hv/PERFILBAJACALIDAD.jpg)
...
Los diagramas de nivel de código en la arquitectura de software son una herramienta de representación utilizada para mostrar la estructura interna de un sistema de software con un alto grado de detalle, abarcando clases, métodos y sus interconexiones. Estos esquemas resultan beneficiosos para adquirir una comprensión de cómo se vinculan las diversas componentes de un sistema de software y cómo se lleva a cabo la implementación de las funciones a nivel de código				
##### 5.7.7 Bounded Context Domain Layer Class Diagrams
Los diagramas de estratificación de dominio facilitan la representación visual de la disposición de las capas dentro de la arquitectura de software en el ámbito del negocio. Cada capa de dominio se ilustra como un bloque, y las conexiones entre estas capas se indican mediante flechas o líneas.
![Diagrama clases Suscription](https://cdn.discordapp.com/attachments/1143666758042013890/1152481306656120885/image.png)
...
![2.png (155×500) (ibb.co)](https://i.ibb.co/92GWmVZ/2.png)


![3.png (160×582) (ibb.co)](https://i.ibb.co/CP0yvZX/3.png)	
	
Tablet:
		
En esta seccion, se muestra como se ve la landing  page en dispositivos de tablet.	
		
![4.png (362×751) (ibb.co)](https://i.ibb.co/mqYgwjR/4.png)

		
![5.png (362×672) (ibb.co)](https://i.ibb.co/WGQLq75/5.png)
...
![10.png (182×741) (ibb.co)](https://i.ibb.co/nPbWmCg/10.png)


![11.png (191×753) (ibb.co)](https://i.ibb.co/fqLVPwx/11.png)


![12.png (157×722) (ibb.co)](https://i.ibb.co/02THSQd/12.png)	
...
![47.png (1025×523) (postimg.cc)](https://i.postimg.cc/c4WCWGfF/47.png)

![48.png (1125×523) (postimg.cc)](https://i.postimg.cc/59S1wYFm/48.png)

![49.png (548×556) (postimg.cc)](https://i.postimg.cc/T3FXRnZT/49.png)

![50.png (1280×292) (postimg.cc)](https://i.postimg.cc/j2sp8cJ4/50.png)

![51.png (845×286) (postimg.cc)](https://i.postimg.cc/MKLLRqtD/51.png)

![44.png (1027×651) (postimg.cc)](https://i.postimg.cc/hG2PbXYw/44.png)
####  Mobile Application Wireframes
![53.png (433×443) (postimg.cc)](https://i.postimg.cc/HL6Xcs9W/53.png)

![54.png (648×461) (postimg.cc)](https://i.postimg.cc/fy92Zg0N/54.png)

![57.png (1112×460) (postimg.cc)](https://i.postimg.cc/9FPbp9dJ/57.png)
...
![63.png (975×678) (postimg.cc)](https://i.postimg.cc/xCD8dXXb/63.png)

![64.png (987×651) (postimg.cc)](https://i.postimg.cc/Tw626BsV/64.png)
...
![65.png (742×527) (postimg.cc)](https://i.postimg.cc/43Cs6rsD/65.png)
-US06 Distancia de siembra entre las plantas
![66.png (741×538) (postimg.cc)](https://i.postimg.cc/PxTHcYLK/66.png)
-US07 Distancia de profundidad de siembra
![67.png (771×572) (postimg.cc)](https://i.postimg.cc/1R01pG19/67.png)

![68.png (717×613) (postimg.cc)](https://i.postimg.cc/Z5nktXBR/68.png)

-US08 Y US09 Fechas de fertilización   Fechas de fumigación
![72.png (978×678) (postimg.cc)](https://i.postimg.cc/6QVfHpWG/72.png)
...
![20.png (1235×483) (ibb.co)](https://i.ibb.co/2cY5b0q/20.png)
![21.png (1267×521) (ibb.co)](https://i.ibb.co/QFBgPc9/21.png)
...
![26.png (696×647) (ibb.co)](https://i.ibb.co/F3LJ8Nc/26.png)
...
![30.png (781×747) (postimg.cc)](https://i.postimg.cc/FH4hcyTG/30.png)
![31.png (1137×722) (postimg.cc)](https://i.postimg.cc/T1gZYSvx/31.png)
![32.png (1252×630) (postimg.cc)](https://i.postimg.cc/sg60yyGS/32.png)
![33.png (1186×688) (postimg.cc)](https://i.postimg.cc/TYkc502v/33.png)
![34.png (1032×775) (postimg.cc)](https://i.postimg.cc/fyVR2MdK/34.png)
...
### 6.1.4. Software Deployment Configuration
  ...
  **Landing Page:
  ...
  - **Nos vamos a configuración, a la sección de page** ![segundo.png (1446×740) (ibb.co)](https://i.ibb.co/NCxYj8d/segundo.png)
...
| US020 | Mejorar su plan | ST0016 | iseñar e implementar la vista y funcionalidad de mejora de plan | 8 horas | Bruno | Done|
| TS006 | Gestión de dispositivos vinculados | ST0017 | Implementar funcionalidades de gestión de dispositivos | 8 horas | Enrique | Done|
| TS008 | Notificaciones y alertas| ST0018 | Diseñar e implementar las vistas y funcionalidades de las notificaciones | 8 horas | Rafael | Done|
| TS005 | Integraciones de Dispositivos IoT | ST0019 | Diseñar e implementar funcionalidades de dispositivos IoT con el Backend | 8 horas | Diego | Done|
| TS007 | Visualización de Datos en la Interfaz de Usuario | ST0020 | Diseñar la visualización de datos en tiempo real | 8 horas | Enrique | Done|
...
| Vídeo exposición TB1 |  | 
|-----------|-----------|



<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE1NzE5MDc0MzYsLTYyMzU0Mjc0OCwtMT
